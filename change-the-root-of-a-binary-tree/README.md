<h2>1666. Change the Root of a Binary Tree</h2><h3>Medium</h3><hr><div><p>Given the <code>root</code> of a binary tree and a <code>leaf</code> node, reroot the tree so that the <code>leaf</code> is the new root.</p>
